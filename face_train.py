...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    ...
    # Training directory
    train_dir = os.listdir('dataset1/')

    for person in train_dir:
        pix = os.listdir("dataset1/" + person)

        for person_img in pix:
            face = face_recognition.load_image_file("dataset1/" + person + "/" + person_img)
    ...
    with open("employee_data1.pkl", 'wb') as f:
...
if __name__ == "__main__":
    ...
    classifier = train("dataset1", model_save_path="trained_knn_model1.clf", n_neighbors=2)
